...
To load completions in your current shell session:
	...
	source <(kasapi-cli completion zsh)

To load completions for every new session, execute once:

#### Linux:

	kasapi-cli completion zsh > "${fpath[1]}/_kasapi-cli"

#### macOS:

	kasapi-cli completion zsh > $(brew --prefix)/share/zsh/site-functions/_kasapi-cli

You will need to start a new shell for this setup to take effect.


```
kasapi-cli completion zsh [flags]
```
