## kasapi-cli sambausers

Inspect Samba/CIFS users visible to the login (get_sambausers)

### Options

```
  -h, --help   help for sambausers
```
...
* [kasapi-cli sambausers get](kasapi-cli_sambausers_get.md)	 - Show details for a single Samba user (get_sambausers with samba_login)
* [kasapi-cli sambausers list](kasapi-cli_sambausers_list.md)	 - List all Samba users (get_sambausers, no filter)
