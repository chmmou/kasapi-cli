...
* [kasapi-cli sambausers add](kasapi-cli_sambausers_add.md)	 - Create a Samba user (add_sambauser; the login is generated by KAS)
* [kasapi-cli sambausers delete](kasapi-cli_sambausers_delete.md)	 - Delete a Samba user (delete_sambauser)
...
* [kasapi-cli sambausers update](kasapi-cli_sambausers_update.md)	 - Replace mutable fields of a Samba user (update_sambauser)
