## kasapi-cli sambausers add

Create a Samba user (add_sambauser; the login is generated by KAS)

```
kasapi-cli sambausers add --password <pw> --comment <text> --path <p> [flags]
```
