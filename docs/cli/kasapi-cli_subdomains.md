...
* [kasapi-cli subdomains get](kasapi-cli_subdomains_get.md)	 - Show details for a single subdomain (get_subdomains with subdomain_name)
* [kasapi-cli subdomains list](kasapi-cli_subdomains_list.md)	 - List all subdomains (get_subdomains)
