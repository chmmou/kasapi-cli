## kasapi-cli softwareinstalls get

Show details for a single software template (get_softwareinstall with software_id)

```
kasapi-cli softwareinstalls get <software-id> [flags]
```
