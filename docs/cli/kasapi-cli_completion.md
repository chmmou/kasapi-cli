## kasapi-cli completion

Generate the autocompletion script for the specified shell

### Synopsis

Generate the autocompletion script for kasapi-cli for the specified shell.
...
* [kasapi-cli completion bash](kasapi-cli_completion_bash.md)	 - Generate the autocompletion script for bash
* [kasapi-cli completion fish](kasapi-cli_completion_fish.md)	 - Generate the autocompletion script for fish
* [kasapi-cli completion powershell](kasapi-cli_completion_powershell.md)	 - Generate the autocompletion script for powershell
* [kasapi-cli completion zsh](kasapi-cli_completion_zsh.md)	 - Generate the autocompletion script for zsh
