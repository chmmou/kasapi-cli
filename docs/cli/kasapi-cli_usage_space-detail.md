## kasapi-cli usage space-detail

Show per-directory disk usage (get_space_usage)

```
kasapi-cli usage space-detail [flags]
```

### Options

```
      --directory string   directory to drill into; empty queries the document-root level
  -h, --help               help for space-detail
```
