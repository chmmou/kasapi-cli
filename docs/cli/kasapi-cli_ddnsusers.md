...
* [kasapi-cli ddnsusers add](kasapi-cli_ddnsusers_add.md)	 - Create a DDNS user (add_ddnsuser; the login is generated by KAS)
* [kasapi-cli ddnsusers delete](kasapi-cli_ddnsusers_delete.md)	 - Delete a DDNS user (delete_ddnsuser)
...
* [kasapi-cli ddnsusers update](kasapi-cli_ddnsusers_update.md)	 - Replace mutable fields of a DDNS user (update_ddnsuser)
