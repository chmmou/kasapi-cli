...
```
  -h, --help   help for softwareinstalls
```
...
* [kasapi-cli softwareinstalls get](kasapi-cli_softwareinstalls_get.md)	 - Show details for a single software template (get_softwareinstall with software_id)
* [kasapi-cli softwareinstalls list](kasapi-cli_softwareinstalls_list.md)	 - List all installable software templates (get_softwareinstall, no filter)
