...
* [kasapi-cli ftpusers add](kasapi-cli_ftpusers_add.md)	 - Create an FTP user (add_ftpuser; the login is generated by KAS)
* [kasapi-cli ftpusers delete](kasapi-cli_ftpusers_delete.md)	 - Delete an FTP user (delete_ftpuser)
...
* [kasapi-cli ftpusers update](kasapi-cli_ftpusers_update.md)	 - Replace mutable fields of an FTP user (update_ftpuser)
