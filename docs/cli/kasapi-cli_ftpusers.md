...
Inspect FTP users visible to the login (get_ftpusers)

### Options

```
  -h, --help   help for ftpusers
```
...
* [kasapi-cli ftpusers get](kasapi-cli_ftpusers_get.md)	 - Show details for a single FTP user (get_ftpusers with ftp_login)
* [kasapi-cli ftpusers list](kasapi-cli_ftpusers_list.md)	 - List all FTP users (get_ftpusers, no filter)
